...
function renderBottomNav(activePage) {
  const pages = [
    ...
    { id: 'chart',     href: '/chart',     label: 'Grafik',    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 14l3-3 3 3 4-4"/></svg>' },
